...
<head>
   ...
   <title>Cập nhật hồ sơ - Admin</title>
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" placeholder="Cập nhật tên" required class="box">
            <span>Email:</span>
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Nhập mật khẩu cũ trước" class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="admin_page.php" class="option-btn">Trở về</a>
      </div>
   </form>
