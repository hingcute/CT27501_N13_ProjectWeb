...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="name" placeholder="Nhập tên" required class="box" value="<?= $fetch_products['name']; ?>">
      ...
      <textarea name="details" required placeholder="Nhập mô tả" class="box" cols="30" rows="10"><?= $fetch_products['details']; ?></textarea>
