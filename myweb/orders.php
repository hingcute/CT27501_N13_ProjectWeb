...
<section class="placed-orders">
   ...
   <div class="box">
      ...
      <p> Trạng thái đơn hàng: <span style="color:<?php if($fetch_orders['payment_status'] == 'Chờ duyệt' or $fetch_orders['payment_status'] == 'Thất bại' ){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">Bạn chưa đặt hàng :(</p>';
   }
   ?>
